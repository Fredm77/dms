   ...
   <div class="col-md-1">
    ...
    <div class="col-md-6">
        ...
        <table class="table table-striped" style="background-color: rgb(163, 163, 163);color:rgb(1, 5, 14);">
          ...
          <?php
                           $connect=mysqli_connect("localhost","root","","marks");
                           $q=mysqli_query($connect,"select students.sid,fname,lname,mathematics,sport,discipline from students,scores where scores.sid=students.sid;");
...
//     $scid= $_GET['id'];
//     $connect=mysqli_connect("localhost","root","","marks"); 
//     $qeury=mysqli_query($connect,"DELETE FROM students,scores where scores.scid='$scid' and where student.sid=scores.sid;");
