<?php
if(isset($_POST["sid"] )&&isset($_POST["email"])){
    $sid=$_POST["sid"];
    $email=$_POST["email"];
    $connect=mysqli_connect("localhost","root","","marks");
    $q=mysqli_query($connect,"select * from students where students.sid='$sid' and students.email='$email'");
    ...
    <div class="container-fluid">
        <div class="center">
            ...
            <form method="post">
               ...
               <input type="submit" value="Get Marks" name="login" class="login">
